...
describe("Top Menu", function() {
 ...
 assert.equal($(naslov).getText(), "INFORMACIJSKI PAKET ZA STUDENTE");
 ...
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Studentski zbor");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3[2]');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Ured za studentska pitanja");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Prodekanski sat za studente");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Povjerenstvo za nastavu i studentska pitanja");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Studentski pravobranitelj");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Studentski prodekan");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Kandidatura za pohvalu za izvannastavne aktivnosti");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Studentski klubovi i izdanja");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Sustav za kvalitetu-studenti");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Odlazna mobilnost studenata");
 ...
 it("Buducim studentima", function() {
       ...
       var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
       naslov.waitForExist(90000);
       assert.equal($(naslov).getText(), "Upis studenata u akademsku godinu 2019./2020.");
       ...
       var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
       naslov.waitForExist(90000);
       assert.equal($(naslov).getText(), "Upisi na diplomske sveučilišne studije");
       ...
       $(buducimStudentima).moveTo();
       var infoPaketi = $('//*[@id="top-menu"]/li[3]/ul/li[3]/a');
       infoPaketi.waitForExist(9000);
       infoPaketi.click();
       var naslov = '//*[@id="page"]/div/div/div[1]/h3';
       $(naslov).waitForExist(90000);
       assert.equal($(naslov).getText(), "INFORMACIJSKI PAKET ZA STUDENTE");
       ...
       var naslov = '//*[@id="page"]/div/div/div[1]/h3';
       $(naslov).waitForExist(90000);
       assert.equal($(naslov).getText(), "Zašto studirati na Filozofskom fakultetu u Osijeku?");
 ...
 var naslov = '//*[@id="page"]/div/div/div[1]/h3';
$(naslov).waitForExist(90000);
 assert.equal($(naslov).getText(), "KONTAKT");
 ...
 var naslov = '//*[@id="page"]/div/div/div[1]/h3';
$(naslov).waitForExist(90000);
assert.equal($(naslov).getText(), "GDJE SMO?");
 ...
 var naslov = '//*[@id="page"]/div/div/div[1]/h3';
       $(naslov).waitForExist(90000);
       assert.equal($(naslov).getText(), "PROMOCIJA PRVOSTUPNIKA");
 ...
 var naslov = '//*[@id="page"]/div/div/div[1]/h3';
       $(naslov).waitForExist(90000);
       assert.equal($(naslov).getText(), "PROMOCIJA MAGISTARA");
 ...
 var naslov = '//*[@id="page"]/div/div/div[1]/h3';
       $(naslov).waitForExist(90000);
       assert.equal($(naslov).getText(), "DOGAĐANJA I SKUPOVI");
