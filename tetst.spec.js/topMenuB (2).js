...
describe("Main Menu", function() {
 ...
 var naslovStranice = $('//*[@id="page"]/div/div/div[1]/h3');
 naslovStranice.waitForExist();

 assert.equal($(naslovStranice).getText(), "Misija i vizija");
...
var dekanica = $('//*[@id="dean"]/div/div/div[1]');
 dekanica.waitForExist();
...
var naslovStranice = $('//*[@id="page"]/div/div/div[2]/h3');
 naslovStranice.waitForExist();

 assert.equal($(naslovStranice).getText(), "Nastavnici");
...
var naslovStranice = $('//*[@id="page"]/div/div/div[2]/h3');
 ...
 assert.equal($(naslovStranice).getText(), "Fakultetske službe");
...
var imenikPopis = $(".abecedno");
 imenikPopis.waitForExist();
...
var naslovStranice = $('//*[@id="page"]/div/div/div[1]/h3');
 ...
 assert.equal($(naslovStranice).getText(), "Suradnja");
...
var naslovStranice = $('//*[@id="page"]/div/div/div[1]/h3');
 ...
 assert.equal($(naslovStranice).getText(), "Dokumenti");
...
var naslovStranice = $('//*[@id="page"]/div/div/div[1]/h3');
 ...
 assert.equal($(naslovStranice).getText(), "Javna nabava");
...
var naslovStranice = $('//*[@id="page"]/div/div/div[1]/h3');
 ...
 assert.equal($(naslovStranice).getText(), "Pravo na pristup informacijama");
...
var naslovStranice = $('//*[@id="page"]/div/div/div[1]/h3');
 ...
 assert.equal($(naslovStranice).getText(), "Zaštita osobnih podataka");
...
var naslovStranice = $('//*[@id="page"]/div/div/div[1]/h3');
 ...
 assert.equal($(naslovStranice).getText(), "Plan zgrade");
...
var naslovStranice = $('//*[@id="page"]/div/div/div[1]/h3');
 ...
 assert.equal($(naslovStranice).getText(), "FAQ");
 ...
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Sustav za kvalitetu");
...
$(odsjeciKatedre).waitForExist(9000);
 $(odsjeciKatedre).moveTo();
 var padajuciIzbornik3 = $('//*[@id="menu"]/li[4]/ul');
 padajuciIzbornik3.waitForExist(9000);
 $('//*[@id="menu"]/li[4]/ul/li[1]').waitForExist(90000);
 $('//*[@id="menu"]/li[4]/ul/li[1]').moveTo();
 var engleski = $('//*[@id="menu"]/li[4]/ul/li[1]/a');
 engleski.click();
/*
 var imeOdsjeka = $('//*[@id="page"]/div/div/div[1]/h3[2]');
 imeOdsjeka.waitForExist();

 assert.equal($(imeOdsjeka).getText(), "Odsjek za engleski jezik i  književnost");
*/
...
/*
 ...
 assert.equal($(imeOdsjeka).getText(), "Odsjek za filozofiju");
*/
...
/*
 ...
 assert.equal($(imeOdsjeka).getText(), "Odsjek za hrvatski jezik i književnost");
*/
...
/*
 ...
 assert.equal($(imeOdsjeka).getText(), "Odsjek za informacijske  znanosti");
*/
...
/*
 ...
 assert.equal($(imeOdsjeka).getText(), "Katedra za mađarski jezik i književnost");
*/
...
/*
 ...
 assert.equal($(imeOdsjeka).getText(), "Odsjek za njemački jezik i  književnost");
*/
...
/*
 ...
 assert.equal($(imeOdsjeka).getText(), "Odsjek za pedagogiju");
*/
...
/*
 ...
 assert.equal($(imeOdsjeka).getText(), "Odsjek za povijest");
*/
...
/*
 ...
 assert.equal($(imeOdsjeka).getText(), "Odsjek za psihologiju"); 
*/
...
/*
 ...
 assert.equal($(imeOdsjeka).getText(), "Sociologija");
*/
...
/*
 ...
 assert.equal($(imeOdsjeka).getText(), "Katedra za zajedničke sadržaje");
*/
...
/*
 ...
 assert.equal($(imeOdsjeka).getText(), "Cjeloživotno učenje");
*/
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Odsjeci i katedre");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Nastavni kalendar");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Izvedbeni planovi nastave");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Raspored sati");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Bolonjski programi");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Studijski programi");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3[2]');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Cjeloživotno učenje");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3[2]');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "svi doktorski studiji  (Jezikoslovlje, Književnost i   kulturni identitet, Pedagogija)");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3[2]');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Knjižnica");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3[2]');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Anafora");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3[2]');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Jezikoslovlje");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Ostali časopisi");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3[2]');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Kick");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Libros");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Udžbenici i priručnici");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Znanstvene knjige");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Zbornici");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Biblioteke");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3[2]');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Znanstveni portal");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Događanja i aktivnosti");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Alumni udruga FFOS");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Priče o uspjehu");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "ISKUSTVA STUDENATA KOJI SU SUDJELOVALI U ERASMUS+ MOBILNOSTI");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "ERASMUS+");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Unajmi karijernog mentora");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "STRUČNA PRAKSA");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "IZVANNASTAVNE AKTIVNOSTI ");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "TIPS & TRICKS ");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "KONTAKTIRAJ NAS! ");
 ...
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
 assert.equal($(naslov).getText(), "Centar za karijere");
 var naslov = $('//*[@id="page"]/div/div/div[1]/h3');
 naslov.waitForExist(90000);
