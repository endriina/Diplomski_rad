...
describe("Main Menu", function() {
  ...
  it("O nama", function() {
    ...
    pristupInf.click();
    var pristupInfURL =
      "https://www.ffos.unios.hr/pravo-na-pristup-informacijama";
    var currentURL = browser.getUrl();
  ...
  it("Nastava", function() {
    ...
    izvedbeniPlan.click();
    var izvedbeniPlanURL =
      "https://www.ffos.unios.hr/izvedbeni-planovi-nastave";
    var currentURL = browser.getUrl();
  ...
  it("Studiji", function() {
    ...
    var cjelozivotnoUcenje2URL =
      "https://www.ffos.unios.hr/cjelozivotno-ucenje/";
    var currentURL = browser.getUrl();
    ...
    var poslijediplomskiURL =
      "https://www.ffos.unios.hr/svi-doktorski-studiji-jezikoslovlje-knjizevnost-i-kulturni-identitet-pedagogija/naslovnica";
    var currentURL = browser.getUrl();
  ...
  it("Centar za karijere", function() {
    ...
    iskustva.click();
    var iskustvaURL =
      "https://www.ffos.unios.hr/iskustva-studenata-koji-su-sudjelovali-u-erasmus-mobilnosti";
    var currentURL = browser.getUrl();
    ...
    var karijerniMentorURL =
      "https://www.ffos.unios.hr/unajmi-karijernog-mentora";
    var currentURL = browser.getUrl();
    ...
    var izvannastavneAktivnostiURL =
      "https://www.ffos.unios.hr/izvannastavne-aktivnosti-29-08-2018";
    var currentURL = browser.getUrl();
